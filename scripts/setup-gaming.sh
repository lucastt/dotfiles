...
echo ""
echo "  Steps:"
echo "    1. Disable Secure Boot in BIOS (required for NVIDIA module to load)"
echo "    2. Reboot"
echo "    3. Verify driver:    nvidia-smi"
echo "    4. Launch Steam:     steam"
echo "    5. Enable Proton:    Steam > Settings > Compatibility > Enable Steam Play for all titles"
echo ""
