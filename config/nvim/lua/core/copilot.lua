...
-- Cortesy of @deathbeam

--local utils = require('config.utils')
--local icons = require('config.icons')
--utils.desc('<leader>g', 'AI')
--
...
--})
--
--vim.keymap.set({ 'n' }, '<leader>ga', chat.toggle, { desc = 'AI Toggle' })
--vim.keymap.set({ 'v' }, '<leader>ga', chat.open, { desc = 'AI Open' })
--vim.keymap.set({ 'n' }, '<leader>gx', chat.reset, { desc = 'AI Reset' })
--vim.keymap.set({ 'n' }, '<leader>gs', chat.stop, { desc = 'AI Stop' })
--vim.keymap.set({ 'n' }, '<leader>gm', chat.select_model, { desc = 'AI Models' })
--vim.keymap.set({ 'n', 'v' }, '<leader>gp', chat.select_prompt, { desc = 'AI Prompts' })
